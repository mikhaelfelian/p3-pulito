                                ...
                                if (!empty($penj)) {
                                    ...
                                    foreach ($penj as $penj) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo anchor(base_url('cart/trans_detail.php?id='.general::enkrip($penj->id).'&route=trans_antrian_list.php'), '#' . $penj->no_nota . '@' . $this->db->where('id', $penj->id_app)->get('tbl_pengaturan_cabang')->row()->keterangan, 'class="text-default"') ?></td>
