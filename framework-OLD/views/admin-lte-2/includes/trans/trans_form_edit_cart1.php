                        ...
                        <div class="small-box bg-aqua">
                            <div class="inner text-center">
                                <a href="<?php echo base_url('cart/cart-step-2.php?id_kat1=' . general::enkrip($kategori1->id)) ?>" style="color: #fff;">
                                    <h4><?php echo ucwords($kategori1->kategori) ?></h4>
                            ...
                            <div class="icon">
                                <a href="<?php echo base_url('cart/cart-step-2-edit.php?nota='.$this->input->get('nota').'&id_kat1=' . general::enkrip($kategori1->id)) ?>" style="color: #e0d7d7 transparent;">
                                    <!--<i class="ion ion-bag"></i>-->
                                </a>
                            </div>

                            <a href="<?php echo base_url('cart/cart-step-2-edit.php?nota='.$this->input->get('nota').'&id_kat1=' . general::enkrip($kategori1->id)) ?>" class="small-box-footer"><?php echo nbs(2) ?></a>
                        </div>
                    </div>
                <?php } ?>
            </div>
