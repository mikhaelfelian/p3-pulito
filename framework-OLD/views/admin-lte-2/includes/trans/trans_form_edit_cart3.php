            ...
            <div class="row">
                ...
                <div class="col-lg-<?php echo (isset($_GET['id_kat1']) ? '12' : '12') ?>">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <?php if (isset($_GET['id_kat1'])) { ?>
                                <?php echo form_open(base_url('cart/cart_simpan_edit.php')) ?>
                                ...
                                <table id="keranjang" class="table table-stripped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo form_textarea(array('id' => 'ket', 'name' => 'ket_tambahan[]', 'class' => 'form-control', 'placeholder' => 'Keterangan ...')) ?></td>
                                            <td>
                            ...
                            <table class="table table-striped">
                                ...
                                <?php foreach ($cart as $items) { ?>
                                    <?php $subtot = (($items->jml * $items->harga) * $items->uk); ?>
                                    <?php $subtotal = $subtotal + $items->subtotal; ?>
                                    <tr>
                                        <td class="text-center" style="width: 50px; vertical-align: middle;">
                                            <?php echo anchor(base_url('cart/cart_hapus_edit.php?id=' . general::enkrip($items->id) . '&id_kat1=' . $this->input->get('id_kat1') . '&id_kat2=' . $this->input->get('id_kat2') . '&nota='.$this->input->get('nota')), '<i class="fa fa-remove"></i>', 'class="text-danger" onclick="return confirm(\'Hapus ?\')"') ?>
                                        </td>
                                        ...
                                        <?php echo form_hidden('rowid', $items->id) ?>
                                        <?php echo form_hidden('id_kat1', $this->input->get('id_kat1')) ?>
                                        <?php echo form_hidden('id_kat2', $this->input->get('id_kat2')) ?>
                                        <td class="text-right" style="width: 75px;">
                                            <?php echo form_input(array('id' => 'jml', 'name' => 'jml', 'class' => 'form-control', 'style' => 'width: 50px; text-align:center;', 'value' => $items->jml)) ?>
                                        </td>
                                        <td class="text-left">
                                            <button class="btn btn-info btn-flat"><i class="fa fa-recycle"></i></button>
                                        </td>
                                        <?php echo form_close() ?>
                                        <td class="text-right" style="vertical-align: middle;"><?php echo general::format_angka($items->harga); ?></td>
                                        <td class="text-right" style="vertical-align: middle;"><?php echo general::format_angka($items->charge); ?></td>
                                        <td class="text-right" style="vertical-align: middle;"><?php echo general::format_angka($items->promo); ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left" colspan="6" style="vertical-align: middle;">
                                            <i><?php echo ucwords($items->keterangan) ?></i>                                            
                                        </td>
                        ...
                        <div class="box-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-6 text-right">
                                    <button class="btn btn-primary btn-flat" onclick="window.location.href = '<?php echo base_url('cart/set_nota_simpan_edit.php?nota='.$this->input->get('nota')) ?>'">Lanjut &raquo;</button>
                                </div>
                            </div>
                        </div>
                    </div>
