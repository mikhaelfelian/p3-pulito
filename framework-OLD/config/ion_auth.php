 ...
 */
$config['site_title']                 = "NGSpecialist.com";       // Site Title, example.com
 ...
 */
$config['remember_cookie_name'] = 'GeTLndryMasterFront_RemCode';
$config['identity_cookie_name'] = 'GeTLndryMasterFront_Identity';
