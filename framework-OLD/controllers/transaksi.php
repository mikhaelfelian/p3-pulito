...
//                           ->like('tbl_trans_jual.status_bayar', $sb)
            ...
            /* -- Blok Pagination -- */
            $config['base_url']              = base_url('cart/trans_order_list.php?filter_nota='.$nt.'&filter_tgl='.$tg.'&filter_sales='.$sl.'&filter_status='.$sn.'&filter_lokasi='.$lk.'&jml='.$jml);
...
//                           ->where('DATE(tbl_trans_jual.tgl_masuk)', $tg)
                           ->like('tbl_trans_jual.no_nota', $nt)
...
//                           ->where('tbl_trans_jual.tgl_masuk', $tg)
                           ->like('id_user', ($grup->name == 'superadmin' || $grup->name == 'owner' || $grup->name == 'admin' ? '' : $id_user))
                           ->like('tbl_trans_jual.no_nota', $nt)
                           ->like('tbl_trans_jual.id_app', $lk)
                           ->or_like('tbl_m_pelanggan.nama', $nt)
...
//            $objPHPExcel->getActiveSheet()->getRowDimension(1)->setRowHeight(-1);
            ...
            $objPHPExcel->getActiveSheet()->getStyle('A5:B5')->getFont()->setSize('10')->setName('Tahoma')->setBold(TRUE);
...
//                    ->setCellValue('I3', '');
            ...
            // NOTA PEMESANAN
            $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('A5', 'NOTA PEMESANAN')->mergeCells('A5:B5')
