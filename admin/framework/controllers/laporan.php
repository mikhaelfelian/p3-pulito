...
//            }
            ...
            switch ($case){
                case 'semua':
                    if (!empty($sales)) {
                        $data['penjualan'] = $this->db->select('tbl_trans_jual.id, tbl_trans_jual.id_user, tbl_trans_jual.tgl_masuk, tbl_trans_jual.id_pengambilan, tbl_trans_jual.id_app, tbl_trans_jual.tgl_ambil, tbl_trans_jual.no_nota, tbl_m_pelanggan.nama, DATE(tbl_trans_jual.tgl_simpan) as tgl_simpan, DATE(tbl_trans_jual.tgl_bayar) as tgl_bayar, tbl_trans_jual.jml_gtotal, tbl_trans_jual.jml_bayar, tbl_trans_jual.status_nota, tbl_trans_jual.metode_bayar, tbl_trans_jual.status_bayar, tbl_trans_jual.id_user, tbl_trans_jual.id_pelanggan, tbl_trans_jual.ck_jasa_lipat, tbl_trans_jual.ck_jasa_gantung, tbl_trans_jual.status_bayar, tbl_trans_jual.status_ambil, tbl_trans_jual.pengambilan')
                                        ->join('tbl_m_pelanggan','tbl_m_pelanggan.id=tbl_trans_jual.id_pelanggan')
                                        ->like('metode_bayar', $tipe)
                                        ->where('id_user', $sales)
                                        ->where($where)
...
//                                             ->order_by('tbl_trans_jual.no_nota', 'desc')
                ...
                case 'per_tanggal':
                    ...
                    $keterangan = 'PER TANGGAL '.$this->tanggalan->tgl_indo($kueri);
                    break;
    ...
    public function xls_penjualan(){
        if (akses::aksesLogin() == TRUE) {
            ...
            switch ($case){
                case 'semua':
                    if (!empty($sales)) {
                        $sql = $this->db->select('tbl_trans_jual.id, tbl_trans_jual.id_user, tbl_trans_jual.tgl_masuk, tbl_trans_jual.id_pengambilan, tbl_trans_jual.id_app, tbl_trans_jual.tgl_ambil, tbl_trans_jual.no_nota, tbl_m_pelanggan.nama, DATE(tbl_trans_jual.tgl_simpan) as tgl_simpan, DATE(tbl_trans_jual.tgl_bayar) as tgl_bayar, tbl_trans_jual.jml_gtotal, tbl_trans_jual.jml_bayar, tbl_trans_jual.status_nota, tbl_trans_jual.metode_bayar, tbl_trans_jual.status_bayar, tbl_trans_jual.id_user, tbl_trans_jual.id_pelanggan, tbl_trans_jual.ck_jasa_lipat, tbl_trans_jual.ck_jasa_gantung, tbl_trans_jual.status_bayar, tbl_trans_jual.status_ambil')
                                        ->join('tbl_m_pelanggan','tbl_m_pelanggan.id=tbl_trans_jual.id_pelanggan')
                                        ->like('metode_bayar', $tipe)
                                        ->where('id_user', $sales)
                                        ->where($where)
                ...
                case 'cabang':
                    if($tipe == '0'){
                        $sql = $this->db->select('tbl_trans_jual.id, tbl_trans_jual.id_user, tbl_trans_jual.tgl_masuk, tbl_trans_jual.id_pengambilan, tbl_trans_jual.id_app, tbl_trans_jual.tgl_ambil, tbl_trans_jual.no_nota, tbl_m_pelanggan.nama, DATE(tbl_trans_jual.tgl_simpan) as tgl_simpan, DATE(tbl_trans_jual.tgl_bayar) as tgl_bayar, tbl_trans_jual.jml_gtotal, tbl_trans_jual.jml_bayar, tbl_trans_jual.jml_kurang, tbl_trans_jual.status_nota, tbl_trans_jual.metode_bayar, tbl_trans_jual.status_bayar, tbl_trans_jual.id_user, tbl_trans_jual.id_pelanggan, tbl_trans_jual.ck_jasa_lipat, tbl_trans_jual.ck_jasa_gantung, tbl_trans_jual.status_bayar, tbl_trans_jual.status_ambil')
                                             ->join('tbl_m_pelanggan','tbl_m_pelanggan.id=tbl_trans_jual.id_pelanggan')
                                             ->where($where)
                                             ->like('tbl_trans_jual.id_app', $cabang)
                                             ->like('tbl_trans_jual.id_user', $sales)
                    ...
                    $keterangan     = 'PER CABANG '.$this->tanggalan->tgl_indo($kueri);
                    break;
                ...
                case 'per_rentang':
                    ...
                    $keterangan     = 'DARI '.$this->tanggalan->tgl_indo($tgl_awal).' s/d '.$this->tanggalan->tgl_indo($tgl_akhir);
                    break;
                ...
                case 'per_sales':
                    ...
                    $keterangan     = 'PER KASIR '.strtoupper($this->ion_auth->user($sales)->row()->username);
                    break;
            }
            ...
            // Header Tabel Nota
            $objPHPExcel->getActiveSheet()->getStyle('A1:N6')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('A1', strtoupper($setting->judul))->mergeCells('A1:N1');
            $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('A2', ($setting->alamat))->mergeCells('A2:N2');
            $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('A3', 'S E M A R A N G')->mergeCells('A3:N3');
            $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('A5', 'DATA PENERIMAAN KASIR '.$keterangan)->mergeCells('A5:N5');
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('D7', 'BYR')
                    ->setCellValue('E7', 'CUST')
                    ->setCellValue('F7', 'INV')
                    ->setCellValue('G7', 'TRANSAKSI')
                    ->setCellValue('H7', 'MET')
                    ->setCellValue('I7', 'NO KARTU')
                    ->setCellValue('J7', 'LOKASI')
                    ->setCellValue('K7', 'UANG MUKA')
                    ->setCellValue('L7', 'AMBIL')
                    ->setCellValue('M7', 'TGL AMBL')
                    ->setCellValue('N7', 'KSR AMBL');
            ...
            if(!empty($sql)){
                ...
                foreach ($sql as $penj) {
                    ...
                    $tgl_byr  = explode('-', $penj->tgl_bayar);
                    $metode   = $this->db->select('*')->where('id', $penj->metode_bayar)->get('tbl_m_platform')->row();
                    $platform = $this->db->select('*')->where('id_penjualan', $penj->id)->where('id_platform', $penj->metode_bayar)->get('tbl_trans_jual_plat')->row();
                    $cabang   = $this->db->select('*')->where('id', $penj->id_app)->get('tbl_pengaturan_cabang')->row();
                    $nota_det = $this->db->select('tbl_trans_jual_det.id_app, tbl_trans_jual_det.produk, tbl_trans_jual_det.harga as harga_jual, tbl_trans_jual_det.jml, tbl_trans_jual_det.subtotal')->where('tbl_trans_jual_det.id_app', $penj->id_app)->where('tbl_trans_jual_det.no_nota', $penj->no_nota)->where('tbl_trans_jual_det.id_kategori2 !=', 0)->get('tbl_trans_jual_det')->result();
                    $lokasi   = $this->db->select('tbl_trans_jual_lokasi.keterangan as kode')->join('tbl_m_lokasi','tbl_m_lokasi.id=tbl_trans_jual_lokasi.id_lokasi')->where('tbl_trans_jual_lokasi.id_penjualan', $penj->id)->get('tbl_trans_jual_lokasi')->row();
                    ...
                    $objPHPExcel->getActiveSheet()->getStyle('H'.$cell.':N'.$cell)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->setCellValue('J'.$cell, $lokasi->kode)
                            ->setCellValue('K'.$cell, ($penj->jml_kurang == 0 ? '-' : $penj->jml_bayar))
                            ->setCellValue('L'.$cell, ($penj->status_ambil == 1 ? 'Sudah' : 'Belum'))
                            ->setCellValue('M'.$cell, ($penj->tgl_ambil != '0000-00-00' ? $this->tanggalan->tgl_indo2($penj->tgl_ambil).' ' : ''))
                            ->setCellValue('N'.$cell, $this->ion_auth->user($penj->id_pengambilan)->row()->username);
                        ...
                        case 'semua':
                            if (!empty($sales)) {
                                $sql = $this->db->select('tbl_trans_jual.id, tbl_trans_jual.id_app, tbl_trans_jual.no_nota, tbl_m_pelanggan.nama, DATE(tbl_trans_jual.tgl_simpan) as tgl_simpan, DATE(tbl_trans_jual.tgl_bayar) as tgl_bayar, tbl_trans_jual.jml_gtotal, tbl_trans_jual.jml_bayar, tbl_trans_jual.status_nota, tbl_trans_jual.metode_bayar, tbl_trans_jual.status_bayar, tbl_trans_jual.id_user, tbl_trans_jual.id_pelanggan, tbl_trans_jual.ck_jasa_lipat, tbl_trans_jual.ck_jasa_gantung')
                                                ...
                                                ->like('metode_bayar', $tipe)
                                                    ->where('tbl_trans_jual.status_bayar !=', '0')
//                                                    ->where('tbl_trans_jual.jml_bayar >', '0')
                                                ->where('id_user', $sales)
                                                ->where('tbl_trans_jual_plat.id_platform', $plat->id)
                                                ->order_by('no_nota', 'desc')
                                                ->get('tbl_trans_jual')->result();
...
//                                                     ->like('tbl_trans_jual.id_user', $sales)
                                                     ->group_by('tbl_trans_jual.id_app', $cabang)
                                                     ->order_by('tbl_trans_jual.id', 'DESC')
                                                     ->get('tbl_trans_jual')->row();
                            break;
...
//                                                    ->where('tbl_trans_jual.jml_bayar >', '0')
                                                     ->where('tbl_trans_jual_plat.id_platform', $plat->id)
                                                     ->group_by('tbl_trans_jual.id_user', $sales)
//                                                     ->group_by('tbl_trans_jual.id_app', $cabang)
                                                     ->order_by('tbl_trans_jual.id', 'DESC')
                                                     ->get('tbl_trans_jual')->row();
                            break;
...
//                                             ->order_by('tbl_trans_jual.no_nota', 'desc')
            ...
            $this->fpdf->Ln(0);
            $this->fpdf->SetFont('Arial', 'B', '14');
            $this->fpdf->Cell(27, .75, $keterangan, 0, 1, 'C');
            $this->fpdf->Ln();
...
//            $this->fpdf->Cell(2.5, .5, 'UANG MUKA', 1, 0, 'C', TRUE);
            ...
            if (!empty($sql)) {
                ...
                $this->fpdf->SetFont('Arial', 'B', '11');
                $this->fpdf->Cell(20.25, .5, '', 'T', 0, 'C', FALSE);
                $this->fpdf->Ln();
            } else {
        ...
        if (akses::aksesLogin() == TRUE) {
            ...
            switch ($case){
                ...
                case 'per_sales':
                    ...
                    $keterangan = 'PER KASIR '.$this->ion_auth->user($sales)->row()->username;
                    break;
            }
            ...
            $setting = $this->db->query("SELECT * FROM tbl_pengaturan")->row();
            $judul = "DATA PENERIMAAN KASIR ".$keterangan;
...
//          Header tabel
//            $this->fpdf->Cell(19, .5, strtoupper($setting->judul), 0, 0, 'L', FALSE);
//            $this->fpdf->Ln();
//            $this->fpdf->Cell(19, .5, strtoupper($setting->alamat), 0, 0, 'L', FALSE);
//            $this->fpdf->Ln();
//            $this->fpdf->Cell(19, .5, 'S E M A R A N G', 0, 0, 'L', FALSE);
//            $this->fpdf->Ln();
//            
            $this->fpdf->Cell(1, .5, 'NO', 1, 0, 'C', TRUE);
            $this->fpdf->Cell(2.25, .5, 'TANGGAL', 1, 0, 'C', TRUE);
...
//            $this->fpdf->Cell(1.5, .5, 'SALES', 1, 0, 'L', TRUE);
            ...
            if (!empty($sql)) {
                ...
                foreach ($sql as $penj) {
                    ...
                    $cabang   = $this->db->select('*')->where('id', $penj->id_app)->get('tbl_pengaturan_cabang')->row();
                    $nota_det = $this->db->select('tbl_trans_jual_det.id_app, tbl_trans_jual_det.produk, tbl_trans_jual_det.harga as harga_jual, tbl_trans_jual_det.jml, tbl_trans_jual_det.subtotal')->where('tbl_trans_jual_det.id_app', $penj->id_app)->where('tbl_trans_jual_det.no_nota', $penj->no_nota)->where('tbl_trans_jual_det.id_kategori2 !=', 0)->get('tbl_trans_jual_det')->result();
//                    $lokasi   = $this->db->select('tbl_m_lokasi.kode')->join('tbl_m_lokasi','tbl_m_lokasi.id=tbl_trans_jual_lokasi.id_lokasi')->where('tbl_trans_jual_lokasi.id_penjualan', $penj->id)->get('tbl_trans_jual_lokasi')->row();
...
//                    $this->fpdf->Ln();
                ...
                foreach ($sql_plat->result() as $plat) {
                    switch ($case){
                        ...
                        case 'cabang':
                            $nota     = $this->db->select('tbl_trans_jual.no_nota, SUM(tbl_trans_jual.jml_gtotal) as jml_gtotal')
                                                 ...
                                                 ->where('tbl_trans_jual.status_bayar !=', '0')
                                                 ->where('tbl_trans_jual.jml_bayar >', '0')
                                                 ->where('tbl_trans_jual.id_app', $cabang->id)
                                                 ->get('tbl_trans_jual')->row(); 
                            break;
                    ...
                    $gttotal = $gttotal + $nota->jml_gtotal;
                    $i++;
                }
                    
                    
                $this->fpdf->Cell(17, .5, 'TOTAL', '', 0, 'R', FALSE);
                $this->fpdf->Cell(2.5, .5, general::format_angka($gttotal), '', 0, 'R', FALSE);
                $this->fpdf->Cell(7.5, .5, '', '', 0, 'R', FALSE);
                $this->fpdf->Ln();
            } else {
...
//                    }
    ...
    public function pdf_packing(){
        if (akses::aksesLogin() == TRUE) {
            ...
            $keterangan = (!empty($tgl_awal) && !empty($tgl_akhir) ? 'Dari '.$this->tanggalan->tgl_indo($tgl_awal).' s/d '.$this->tanggalan->tgl_indo($tgl_akhir) : 'PER TANGGAL '.$this->tanggalan->tgl_indo($kueri) );
            ...
            $this->fpdf->Ln(0);
            $this->fpdf->SetFont('Arial', 'B', '14');
            $this->fpdf->Cell(19, .75, $keterangan, 0, 1, 'C');
            $this->fpdf->Ln();
