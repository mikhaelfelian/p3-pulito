<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Import <small>Transaksi</small></h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Log Import</h3>
                    </div>
                    <div class="box-body">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td><?php echo $exp->file ?></td>
                                <td><?php echo anchor('page=pengaturan&act=import_hapus&id='.general::enkrip($exp->id).'&file='.$exp->file,'<i class="fa fa-remove"></i> Hapus','class="text-danger" onclick="return confirm(\'Hapus ?\')"') ?></td>
                            </tr>
                            <?php } ?>
                        </table>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        <?php echo form_open_multipart('page=pengaturan&act=import_create') ?>
                            <label>File</label>
                            <input type="file" name="frestore" value="" accept="application/json" />                       <br/>
                            <button  class="btn btn-primary btn-flat"><i class="fa fa-upload"></i> Import</button>
                        <?php echo form_close() ?>
                    </div>
                </div>
            </div>
