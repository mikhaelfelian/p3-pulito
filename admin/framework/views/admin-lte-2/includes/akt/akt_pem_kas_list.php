<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Pemasukan Kas<small></small></h1>
        <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <?php echo form_open('page=akuntability&act=set_cari_pem_kas') ?>
                            ...
                            <tbody>
                                ...
                                if (!empty($pemasukan)) {
                                    ...
                                    foreach ($pemasukan as $pemasukan) {
                                        ...
                                        $tot_pem = $tot_pem + $pemasukan->nominal;
                                        ?>
                                        <tr>
                                            <td><?php echo $no++ ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right text-bold" colspan=""><?php echo general::format_angka($tot_pem) ?></td>
