<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?php echo form_open('page=akuntability&act=akt_pem_simpan', '') ?>
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form Pemasukan</h3>
                    </div>
                    <div class="box-body">
            ...
            <div class="col-lg-8">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <?php echo form_open('page=akuntability&act=set_cari_pem') ?>
                            ...
                            <tbody>
                                ...
                                if (!empty($pemasukan)) {
                                    ...
                                    foreach ($pemasukan as $pemasukan) {
                                        ...
                                        <tr>
                                            <td><?php echo $no++ ?></td>
                                            <td><?php echo ucwords($pemasukan->status_kas) ?></td>
