<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?php echo form_open('page=laporan&act=set_lap_member_dep', '') ?>
                ...
                <div class="col-lg-12">
                    <div class="box box-warning">
                        ...
                        <div class="box-body table-responsive">
                            <button class="btn btn-success btn-flat" onclick="window.location.href = '<?php echo site_url('page=laporan&act=deposit_pdf&nik='.$this->input->get('nik').'&nama='.$this->input->get('nama')) ?>'"><i class="fa fa-file-pdf-o"></i> Cetak</button>
                            <br/>
                            <br/>
                            <table class="table table-striped">
                                <thead>                                    
                                    <tr>
                                        ...
                                        <th class="text-right">Jml Deposit</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $no = 1; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo general::format_angka($member->jml_deposit) ?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
