<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Data Penjahit <small></small></h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?php echo form_open('page=produk&act=prod_penj_simpan', '') ?>
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form Penjahit</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group <?php echo (!empty($hasError['penjahit']) ? 'has-error' : '') ?>">
                            <label class="control-label">Nama Penjahit</label>
                            <?php echo form_input(array('name' => 'penjahit', 'class' => 'form-control')) ?>
                        </div>
                                ...
                                if (!empty($penjahit)) {
                                    ...
                                    foreach ($penjahit as $penjahit) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $penjahit->keterangan ?></td>
                                            <td><?php echo anchor('page=produk&act=prod_penj_hapus&id=' . general::enkrip($penjahit->id), '<i class="fa fa-remove"></i> Hapus', 'onclick="return confirm(\'Hapus [' . $penjahit->penjahit . '] ? \')" class="text-danger"') ?></td>
                                        </tr>
                                        <?php
                                    }
                                }
