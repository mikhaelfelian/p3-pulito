<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-5">
                <?php echo form_open('page=produk&act=prod_pelanggan_'.(isset($_GET['id']) ? 'update' : 'simpan'), '') ?>
                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <div class="form-group <?php echo (!empty($hasError['nik']) ? 'has-error' : '') ?>">
                            ...
                            <?php echo form_input(array('name' => 'nik', 'class' => 'form-control', 'value' => $member->nik)) ?>
                        </div>
                        <div class="form-group <?php echo (!empty($hasError['nama']) ? 'has-error' : '') ?>">
                            <label class="control-label">Nama</label>
                            <?php echo form_input(array('name' => 'nama', 'class' => 'form-control', 'value' => $member->nama)) ?>
                        </div>
                        <div class="form-group <?php echo (!empty($hasError['no_hp']) ? 'has-error' : '') ?>">
                            <label class="control-label">No. HP</label>
                            <?php echo form_input(array('name' => 'no_hp', 'class' => 'form-control', 'value' => $member->no_hp)) ?>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Alamat</label>
                            <?php echo form_textarea(array('name' => 'alamat', 'class' => 'form-control', 'value' => $member->alamat)) ?>
                        </div>
                        <div class="form-group">
