...
//                                        $tot_jml = $this->db->select('SUM(stok) as jml')->where('id_produk', $produk->id)->get('tbl_m_produk_stok')->row();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(akses::hakAdmin() != TRUE){ ?>
                                                <?php echo anchor('page=produk&act=prod_diskon_hps&id='.general::enkrip($member->id), '<i class="fa fa-remove"></id> Hapus','class="text-danger" onclick="return confirm(\'Hapus ?\')"') ?>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php
