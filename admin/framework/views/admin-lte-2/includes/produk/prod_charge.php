<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <?php echo form_open('page=produk&act=prod_charge_simpan', '') ?>
...
<!--                        <div class="form-group <?php echo (!empty($hasError['jml']) ? 'has-error' : '') ?>">
                            ...
                            <?php // echo form_input(array('name' => 'nominal', 'class' => 'form-control', 'style'=>'width: 120px;')) ?>
                        </div> -->
                        <div class="form-group <?php echo (!empty($hasError['jml']) ? 'has-error' : '') ?>">
                            <label class="control-label">Nominal</label>
                            <div class="input-group date">
                                ...
                                <?php echo form_input(array('id'=>'nominal','name' => 'nominal', 'class' => 'form-control')) ?>
                            </div>
                        </div> 
                        <div class="form-group <?php echo (!empty($hasError['jml']) ? 'has-error' : '') ?>">
                            ...
                            <div class="input-group date">
                                ...
                                <?php echo form_input(array('id'=>'persen','name' => 'persen', 'class' => 'form-control')) ?>
                            </div>
                        </div> 
                        ...
                        <div class="form-group <?php echo (!empty($hasError['keterangan']) ? 'has-error' : '') ?>">
                            ...
                            <br/>
                            <?php echo form_radio(array('name' => 'status_dep', 'value' => '1')) ?> Persen
                            <?php echo nbs(2) ?>
                            <?php echo form_radio(array('name' => 'status_dep', 'value' => '0')) ?> Nominal
                        </div>
                    </div>
            ...
            <div class="col-lg-8">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Data Charge / Biaya</h3>
                    </div>
                    <div class="box-body">                        
...
//                                        $tot_jml = $this->db->select('SUM(stok) as jml')->where('id_produk', $produk->id)->get('tbl_m_produk_stok')->row();
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo general::format_angka($member->persen) ?></td>
                                            <td><?php echo general::format_angka($member->nominal) ?></td>
                                            <td><?php echo $member->keterangan ?></td>
                                            <!--<td><?php // echo general::status_dep($member->status_deposit) ?></td>-->
                                            <td><?php if(akses::hakAdmin() != TRUE){ ?><?php echo anchor('page=produk&act=prod_charge_hps&id='.general::enkrip($member->id), '<i class="fa fa-remove"></id> Hapus','class="text-danger" onclick="return confirm(\'Hapus ?\')"') ?><?php } ?></td>
                                        </tr>
                                        <?php
                                    }
                                }
