...
if($_SERVER['HTTP_HOST'] != 'localhost'){
    ...
    define('SITE_URL', 'http' . ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') ? 's' : '') . '://' . $_SERVER['SERVER_NAME'] . "" . str_replace("index.php","", $_SERVER['SCRIPT_NAME']));
}
...
$upload_dir = '/assets/gbr/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../assets/gbr/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../assets/gbr/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
