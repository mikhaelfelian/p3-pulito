                    ...
                    <div class="box-body">
                        ...
                        <?php if (!empty($customer)) { ?>
                            <?php if ($penj->status_nota == '0') { ?>
                                <?php echo form_open('page=transaksi&act=cart_edit') ?>
                                    ...
                                    <div class="col-xs-4 table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo anchor('page=transaksi&act=set_nota_hj&id=' . $this->input->get('id') . '&order_ref=' . $this->input->get('order_ref') . '&prod_ref=' . $this->input->get('prod_ref') . '&hrg_ref=' . ceil($prod_brg->harga_jual) . '&route=trans_jual_edit', 'Set Harga') ?></td>
                                            </tr>
                                            <?php foreach ($prod_hrg as $prod_hrg) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo anchor('page=transaksi&act=set_nota_hj&id=' . $this->input->get('id') . '&order_ref=' . $this->input->get('order_ref') . '&prod_ref=' . $this->input->get('prod_ref') . '&hrg_ref=' . ceil($prod_hrg->harga) . '&route=trans_jual_edit', 'Set Harga') ?></td>
                                                </tr>
                                            <?php } ?>
                                        </table>
                                    </div>
                                                ...
                                                if (!empty($penj_det)) {
                                                    ...
                                                    foreach ($penj_det as $penj_det) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left"><?php echo anchor('page=produk&act=prod_det&id='.general::enkrip($penj_det->id_produk),$penj_det->kode) ?></td>
                                                            ...
                                                            <?php if ($penj->status_nota == '0') { ?>
                                                                <td class="text-left"><?php echo anchor('page=transaksi&act=trans_jual_edit&id=' . $this->input->get('id') . '&order_ref=' . general::enkrip($penj_det->id) . '&prod_ref=' . general::enkrip($penj_det->id_produk), '<i class="fa fa-arrow-right"></i> Set Harga') ?></td>
                                                            <?php } else { ?>
                                                                <td class="text-center"></td>
                                                            <?php } ?>
                                                        </tr>
                                                    <?php } ?>
                                                    <?php echo form_open('page=transaksi&act=set_nota_update') ?>
                                                            ...
                                                            <div class="form-group <?php echo (!empty($hasError['tgl_bayar']) ? 'has-error' : '') ?>">
                                                                <div class="input-group date">
                                                                    ...
                                                                    <?php if ($penj->status_bayar == '0') { ?>
                                                                        <?php echo form_input(array('id' => 'tgl_bayar', 'name' => 'tgl_bayar', 'class' => 'form-control', 'value' => ($penj->tgl_bayar != 0 ? $tgl_byr[1] . '/' . $tgl_byr[2] . '/' . $tgl_byr[0] : ''))) ?>
                                                                    <?php } else { ?>
                                                                        <?php echo form_input(array('id' => '', 'name' => 'tgl_bayar', 'class' => 'form-control', 'readonly' => 'TRUE', 'value' => ($penj->tgl_bayar != 0 ? $tgl_byr[1] . '/' . $tgl_byr[2] . '/' . $tgl_byr[0] : ''))) ?>
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                        </th>
                                                    ...
                                                    <tr>
                                                        <th colspan="7" class="text-right" style="">
                                                            ...
                                                            <?php echo nbs(2) ?>
                                                            <input name="status_bayar" value="0" type="radio" <?php echo ($penj->status_bayar == '0' ? 'checked' : '') ?> onclick=""> Not Paid
                                                        </th>
                                                        <th colspan="" class="text-right"></th>
                                                    </tr>
                                                    <tr>
                                                        <th colspan="7" class="text-right" style="">
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-flat" onclick="window.location.href = '<?php echo site_url('page=transaksi&act=trans_jual_hps&id='.$this->input->get('id')) ?>'">Batal</button>
                                                            <button type="submit" class="btn btn-primary btn-flat">Ubah Nota</button>
                                                        </th>
                                                        <th colspan="" class="text-right"></th>
                                                    </tr>
                                                    <?php echo form_close() ?>
