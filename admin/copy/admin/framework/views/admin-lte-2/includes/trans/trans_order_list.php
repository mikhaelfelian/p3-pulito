                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body no-padding">
                        ...
                        <table class="table table-responsive">
                            ...
                            <?php echo form_open('page=transaksi&act=set_cari_trans') ?>
                                ...
                                if (!empty($penj)) {
                                    ...
                                    foreach ($penj as $penj) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo anchor('page=transaksi&act=trans_jual_detail&id='.general::enkrip($penj->id), '#' . $penj->no_nota . '@' . $this->db->where('id', $penj->id_app)->get('tbl_pengaturan_cabang')->row()->keterangan.' - '.$penj->nama.' - '.$penj->no_hp, 'class="text-default"') ?></td>
                                            ...
                                            <td style="width: 200px;">
                                                <?php if (akses::hakOwner() == TRUE OR akses::hakSA() == TRUE) { ?>
                                                    <?php // if ($penj->status_nota == '0') { ?>
                                                        <?php echo anchor('page=transaksi&act=trans_jual_hps&id=' . general::enkrip($penj->id), '<i class="fa fa-remove"></i> Hapus', 'class="label label-danger" onclick="return confirm(\'Yakin menghapus ?\')"') ?>
                                                        <?php echo nbs(2) ?>
                                                    <?php // } ?>
                                                <?php } ?>
                                                <?php echo general::status_bayar($penj->status_bayar) ?>
                                                <?php echo (!empty($penj->pengambilan) ? '['.$penj->pengambilan.' - '.$tgl_ambil[1] . '/' . $tgl_ambil[2] . '/' . $tgl_ambil[0].']' : '') ?>
                                            </td>
                                            <td>
