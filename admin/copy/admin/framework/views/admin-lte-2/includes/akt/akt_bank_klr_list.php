            ...
            <div class="col-lg-12">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <?php echo form_open('page=akuntability&act=set_cari_bank_klr') ?>
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($pemasukan)) {
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="" class="text-right text-bold"><?php echo general::format_angka($tot_pem) ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
