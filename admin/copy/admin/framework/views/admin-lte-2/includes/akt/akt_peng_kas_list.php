<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Pengeluaran Kas<small></small></h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-3">
                <?php echo form_open('page=akuntability&act=akt_peng_kas_simpan', '') ?>
            ...
            <div class="col-lg-9">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <?php echo form_open('page=akuntability&act=set_cari_peng_kas') ?>
                                ...
                                if (!empty($pemasukan)) {
                                    ...
                                    foreach ($pemasukan as $pemasukan) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ucwords($this->db->where('id',$pemasukan->id_jenis)->get('tbl_akt_kas_jns')->row()->jenis) ?></td>
                                            <td><?php echo anchor('page=akuntability&act=akt_peng_hapus&id=' . general::enkrip($pemasukan->id).'&route='.$this->input->get('act'), '<i class="fa fa-remove"></i> Hapus', 'onclick="return confirm(\'Hapus [' . $pemasukan->keterangan . '] ? \')" class="text-danger"') ?></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
