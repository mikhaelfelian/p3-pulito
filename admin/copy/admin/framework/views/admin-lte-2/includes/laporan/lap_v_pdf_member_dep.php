                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="<?php echo site_url('page=laporan&act=pdf_deposit&nik='.$this->input->get('nik').'&nama='.$this->input->get('nama')) ?>">
                            </iframe>
                        </div>
                    </div>
                    <div class="box-footer">
                        <div class="row">
                            <div class="col-lg-6">
                                <button type="button" onclick="window.location.href = '<?php echo site_url('page=laporan&act=data_member') ?>'" class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i> Kembali</button>
                            </div>
                        </div>
                    </div>
                </div>
