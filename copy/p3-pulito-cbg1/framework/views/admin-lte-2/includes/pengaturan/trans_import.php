        ...
        <div class="row">
                    ...
                    <div class="box-body">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td><?php echo anchor(base_url('pengaturan/eksport_download.php?file='.$exp->file),$exp->file) ?></td>
            ...
            <div class="col-lg-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        <?php echo form_open_multipart(base_url('pengaturan/import_create.php')) ?>
                            <label>File</label>
