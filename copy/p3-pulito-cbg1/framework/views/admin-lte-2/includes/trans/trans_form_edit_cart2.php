                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-aqua">
                            <div class="inner text-center">
                                <a href="<?php echo base_url('cart/cart-step-4-edit.php?nota='.$this->input->get('nota').'&id_kat1='.$this->input->get('id_kat1').'&id_kat2='.general::enkrip($kategori2->id)) ?>" style="color: #fff;">
                                    <h4><?php echo ucwords($kategori2->kategori) ?></h4>
                            ...
                            <a href="<?php echo base_url('cart/cart-step-4-edit.php?nota='.$this->input->get('nota').'&id_kat1='.$this->input->get('id_kat1').'&id_kat2='.general::enkrip($kategori2->id)) ?>" class="small-box-footer"><?php echo nbs(2) ?></a>
                        </div>
                    </div>
                <?php } ?>
            </div>
