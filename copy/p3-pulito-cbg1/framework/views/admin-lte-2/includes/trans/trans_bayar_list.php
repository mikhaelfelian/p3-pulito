                            ...
                            <tbody>
                                ...
                                if (!empty($penj)) {
                                    ...
                                    foreach ($penj as $penj) {
                                        ...
                                        $lok	   = $this->db->join('tbl_m_lokasi', 'tbl_m_lokasi.id=tbl_trans_jual_lokasi.id_lokasi')->where('tbl_trans_jual_lokasi.id_penjualan',$penj->id)->get('tbl_trans_jual_lokasi')->row();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $lok->kode.' '.$lok->keterangan ?>
                                            </td>
