                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <th class="text-right" colspan="5" style="vertical-align: middle;">Total</th>
                                ...
                                <tr>
                                    <th colspan="5" class="text-right" style="vertical-align: middle;">Diskon</th>
                                ...
                                <tr>
                                    <th colspan="5" class="text-right" style="vertical-align: middle;">Charge</th>
                                    <th  class="text-right" style="width: 250px;">                                        
                                ...
                                <tr>
                                    ...
                                    <th  class="text-right" style="width: 250px;">
                                        ...
                                        <select id="metode_bayar" name="metode_bayar" class="form-control" <?php echo($penj->status_bayar != '0' ? 'disabled="TRUE"' : '') ?>>
                                            <option value="1">Tunai</option>
                                            <option value="2">Deposit</option>
                                            <?php foreach ($platform as $platform) { ?>
                                                <?php if($platform->id > 2) { ?>
                                                    <option value="<?php echo $platform->id ?>" <?php echo ($penj->metode_bayar == $platform->id ? 'selected' : '') ?>><?php echo $platform->platform ?></option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
                                        <?php // } else { ?>
                                ...
                                <?php if ($penj->jml_kurang > 0) { ?>
                                    <tr>
                                        <th colspan="5" class="text-right" style="vertical-align: middle;">Jml Hrs Bayar</th>
                                        <th  class="text-right" style="width: 250px;">
                                            <div class="input-group date">
                                                <div class="input-group-addon">
                                                    Rp.
								...
								<?php if($penj->jml_kurang > 0){ ?>
                                <tr>
                                    <th colspan="5" class="text-right" style="vertical-align: middle;">Jml Bayar</th>
                                    <th  class="text-right" style="width: 250px;">
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                Rp.
