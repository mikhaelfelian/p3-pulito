                    ...
                    <div class="box-body">
                            ...
                            switch ($_GET['case']) {
                                ...
                                case 'per_rentang':
                                    ...
                                    $uri    = site_url('page=laporan&case=per_rentang&tgl_awal='.$this->input->get('tgl_awal').'&tgl_akhir='.$this->input->get('tgl_akhir').'&cabang='.$this->input->get('cabang').'&tipe='.$this->input->get('tipe'));
                                    break;
