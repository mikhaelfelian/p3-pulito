<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Data Promo <small>Diskon</small></h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?php echo form_open('page=produk&act=prod_promo_simpan', '') ?>
                        ...
                        <table class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                if (!empty($lokasi)) {
                                    ...
                                    foreach ($lokasi->result() as $lokasi) {
...
//                                        $tot_jml = $this->db->select('SUM(stok) as jml')->where('id_produk', $produk->id)->get('tbl_m_produk_stok')->row();
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo general::format_angka($lokasi->nominal) ?></td>
                                            <td>
                                                <?php echo anchor('page=produk&act=prod_promo_hps&id='.general::enkrip($lokasi->id),'<i class="fa fa-remove"></i> Hapus','class="text-danger" onclick="return confirm(\'Hapus ?\')"') ?>
                                            </td>
                                        </tr>
                                        <?php
                                    }
