<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?php echo form_open('page=produk&act=prod_diskon_simpan', '') ?>
...
<!--                        <div class="form-group <?php echo (!empty($hasError['jml']) ? 'has-error' : '') ?>">
                        ...
                        <div class="form-group <?php echo (!empty($hasError['jml']) ? 'has-error' : '') ?>">
                            ...
                            <?php echo form_input(array('name' => 'diskon', 'class' => 'form-control', 'style'=>'width: 120px;')) ?>
                        </div> 
                        ...
                        <div class="form-group <?php echo (!empty($hasError['keterangan']) ? 'has-error' : '') ?>">
                            ...
                            <br/>
                            <?php echo form_checkbox(array('name' => 'status_disk', 'value' => '1')) ?> Global
                        </div>
                    </div>
...
//                                        $tot_jml = $this->db->select('SUM(stok) as jml')->where('id_produk', $produk->id)->get('tbl_m_produk_stok')->row();
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo general::status_diskon($member->tipe) ?></td>
                                            <td><?php echo anchor('page=produk&act=prod_diskon_hps&id='.general::enkrip($member->id), '<i class="fa fa-remove"></id> Hapus','class="text-danger" onclick="return confirm(\'Hapus ?\')"') ?></td>
                                        </tr>
                                        <?php
                                    }
                                }
