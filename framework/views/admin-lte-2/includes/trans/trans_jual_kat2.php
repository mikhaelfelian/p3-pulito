                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-aqua">
                            <div class="inner text-center">
                                <a href="<?php echo base_url('cart/cart-step-3.php?id_kat1='.$this->input->get('id_kat1').'&id_kat2='.general::enkrip($kategori2->id)) ?>" style="color: #fff;">
                                    <h4><?php echo ucwords(character_limiter($kategori2->kategori, 20)) ?></h4>
                                    <p>(<?php echo general::format_angka($kategori2->harga) ?>)</p>
                            ...
                            <a href="<?php echo base_url('cart/cart-step-3.php?id_kat1='.$this->input->get('id_kat1').'&id_kat2='.general::enkrip($kategori2->id)) ?>" class="small-box-footer"><?php echo nbs(2) ?></a>
                        </div>
                    </div>
                <?php } ?>
            </div>
