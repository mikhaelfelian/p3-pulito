                            ...
                            <table class="table table-striped">
                                ...
                                <?php foreach ($penj_det as $items) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">                                            
                                            ...
                                            <?php echo anchor(base_url('cart/trans_edit_ket.php?id='.$_GET['id'].'&itemid='.general::enkrip($items->id)), strtoupper(strtolower($items->produk)), '')   ?> 
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <th  class="text-right" style="width: 250px;">
                                        <select id="jml_diskon" name="jml_diskon" class="form-control" disabled="TRUE">
                                ...
                                <tr>
                                    <th colspan="8" class="text-right" style="vertical-align: middle;">
                                        <?php echo ($penj->status_bayar == '1' ? ($penj->metode_bayar == '1' ? 'Kembali' : 'Sisa Saldo') : 'Kurang Bayar') ?>
                                    ...
                                    <th  class="text-right" style="width: 250px;">
                                        ...
                                        <?php }else{ ?>
                                            <div class="input-group date">                                                
                                                ...
                                                <?php echo form_input(array('id' => 'jml_kurang', 'name' => 'jml_kurang', 'class' => 'form-control pull-right text-right', 'value' => ($penj->status_bayar != '1' ? general::format_angka($penj->jml_kurang) : ''), 'readonly' => 'TRUE')) ?>
                                            </div>
                                        <?php } ?>
