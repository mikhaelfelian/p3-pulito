            ...
            <div class="col-lg-5">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="control-label">Catatan 1</label>
                            <?php echo form_input(array('id' => 'catatan1', 'name' => 'catatan1', 'class' => 'form-control', 'value' => $member->ket1)) ?>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Catatan 2</label>
                            <?php echo form_input(array('id' => 'catatan2', 'name' => 'catatan2', 'class' => 'form-control', 'value' => $member->ket2)) ?>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Catatan 2</label>
                            <?php echo form_input(array('id' => 'catatan3', 'name' => 'catatan3', 'class' => 'form-control', 'value' => $member->ket3)) ?>
                        </div>
                    </div>
